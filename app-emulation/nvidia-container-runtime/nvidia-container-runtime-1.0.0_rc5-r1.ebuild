...
DESCRIPTION="runc container cli tools with nvidia hook"
...
PATCHES="
	${FILESDIR}/0002-Add-prestart-hook-nvidia-container-runtime-hook-to-t.patch
"
...
src_install() {
	...
	mv runc nvidia-container-runtime
